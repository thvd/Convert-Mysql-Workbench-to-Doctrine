...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // _assetic_25493a6
        if ($pathinfo === '/css/25493a6.css') {
            return array (  '_controller' => 'assetic.controller:render',  'name' => '25493a6',  'pos' => NULL,  '_format' => 'css',  '_route' => '_assetic_25493a6',);
        }

        // _assetic_25493a6_0
        if ($pathinfo === '/css/25493a6_style_1.css') {
            return array (  '_controller' => 'assetic.controller:render',  'name' => '25493a6',  'pos' => 0,  '_format' => 'css',  '_route' => '_assetic_25493a6_0',);
        }

        // _assetic_eb3cc7c
        if ($pathinfo === '/js/eb3cc7c.js') {
            return array (  '_controller' => 'assetic.controller:render',  'name' => 'eb3cc7c',  'pos' => NULL,  '_format' => 'js',  '_route' => '_assetic_eb3cc7c',);
        }

        // _assetic_eb3cc7c_0
        if ($pathinfo === '/js/eb3cc7c_modernizr-2.0.6.min_1.js') {
